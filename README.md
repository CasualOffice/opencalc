...
| 5 — Collaboration / web | operation model for shared editing | ⬜ design proposed, not accepted: **server-mediated operational transform, not a CRDT** ([ADR-011](docs/08-ADR-REGISTER.md), [docs/56](docs/56-COLLABORATION-CONCURRENCY-DESIGN.md)). No code. Explicitly **not** part of the embeddable SDK, which is single-user |
