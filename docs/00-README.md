...
| 57 | [Collaboration Server Boundary](57-COLLABORATION-SERVER-BOUNDARY.md) | What the server owns and must not own; webhook callbacks not a file store, and a cluster with a leader per document and no sticky sessions (ADR-012) |
