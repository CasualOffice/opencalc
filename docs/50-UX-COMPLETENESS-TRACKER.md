...
| UX-C01 | **Right-click on row/col header** shows generic cell menu and acts on the *previous* selection (wrong target) | Chrome | 🔴 | Detect header hit in contextmenu, select the row/col, show a header menu |
