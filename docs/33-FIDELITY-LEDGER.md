...
> **This table is hand-maintained, so it only lists constructs someone thought
> to add.** For the measured picture — every element and attribute the ECMA-376
> schema declares, against what actually survives a round trip — see
> [51 — Fidelity Gap Audit](51-FIDELITY-GAP-AUDIT.md), which is generated by
> [`tools/fidelity-audit`](../tools/fidelity-audit). Where the two disagree, 51
> is the evidence and this file is the claim.
